...
class Appr(Inc_Learning_Appr):
    """Class experimenting with the idea of active replay learning: i.e, perform replay only when performance degrades
    """
    ...
    def train_loop(self, t, trn_loader, val_loader):
        ...
        if len(self.exemplars_dataset) > 0 and t > 0 and self.need_replay:
    ...
    def criterion(self, t, outputs, targets, outputs_old=None):
        ...
        if len(self.exemplars_dataset) > 0 and self.need_replay:
