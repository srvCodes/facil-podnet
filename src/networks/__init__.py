...
from .resnet_rebuffi import resnet_rebuffi, resnet_rebuffi_lucir
...
allmodels = tvmodels + ['resnet32', 'LeNet', 'VggNet', 'resnet_rebuffi', 'resnet_cifar', 'resnet_rebuffi_lucir']
